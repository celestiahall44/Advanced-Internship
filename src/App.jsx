        ...
        <nav className="nav">
          <div className="nav__wrapper">
            ...
            <ul className="nav__list--wrapper">
              ...
              <li className="nav__list nav__list--mobile nav__list--login">
          ...
          <div className="row">
            <div className="landing__wrapper">
              <div className="landing__content">
                ...
                <Link className="btn home__cta--btn" to="/login">
                  Login
                </Link>
              </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="footer__copyright--wrapper">
              <div className="footer__copyright">Copyright (c) 2023 Summarist.</div>
            </div>
          </div>
        </div>
        </section>
